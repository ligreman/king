...
export class AccessKeyComponent implements OnInit, OnDestroy {
    ...
    displayedColumns: string[] = ['key', 'consumer', 'created_at', 'ttl', 'tags', 'actions'];
     ...
     * Obtiene las API key
     */
    getApiKeys(loadAll = false) {
        this.api.getApiKeys(1000, this.nextData, this.search, this.searchAnd)
            .subscribe({
                next: (value) => {
